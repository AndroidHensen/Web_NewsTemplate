    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="input-group col-md-3" style="margin-bottom: 20px">
                ...
                <button id="button-push" type="button"
                        class="btn btn-primary dropdown-toggle form-control" data-toggle="dropdown" aria-haspopup="true"
                        aria-expanded="false"><span class="" aria-hidden="true"></span>推送推荐位
                </button>
            </div>
            <!--title-search-->
            <div class="row">
                <form action="/admin.php" method="get">
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-control" name="catid">
                                ...
                                <?php if(is_array($webSiteMenu)): foreach($webSiteMenu as $key=>$sitenav): ?><option value="<?php echo ($sitenav["menu_id"]); ?>"
                                    <?php if($type["catid"] == $sitenav['menu_id']): ?>selected="selected"<?php endif; ?>
                    ...
                    <div class="col-md-3">
                        <div class="input-group">
                            <input class="form-control" name="title" type="text" value="<?php echo ($type["title"]); ?>"
                                   placeholder="文章标题"/>
                        ...
                        <form id="singcms-listorder">
                            <table class="table table-bordered table-hover singcms-table">
                                ...
                                <?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?><tr>
                                        <td><input type="checkbox" name="pushcheck" value="<?php echo ($new["news_id"]); ?>">
                                        </td>
                                        ...
                                        <td><?php echo (getThumb($new["thumb"])); ?></td>
                                        ...
                                        <td><span attr-status="<?php if( $new['status'] == 1): ?>0
                                            ...
                                            id="singcms-on-off" ><?php echo (status($new["status"])); ?></span>
                                            </td>
