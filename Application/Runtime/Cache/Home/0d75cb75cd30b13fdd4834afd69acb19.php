			...
			<div class="row">
				<div class="col-sm-9 col-md-9">
					...
					<div class="news-detail">
						...
						<h5 style="color: #666;">发布日期：<?php echo (date("Y-m-d H:i:s",$vo["create_time"])); ?>&nbsp&nbsp&nbsp来源：<?php echo (getCopyFromById($vo["copyfrom"])); ?>&nbsp&nbsp&nbsp点击：<?php echo ($vo["count"]); ?></h5>
						<?php echo ($vo["content"]); ?>
					</div>
